...
From v7.22.4, we’ve added experimental support for the SockFilter driver. It fixes the issue by solving conflicts in the WFP stack. [Ulteriori informazioni](/archive/adguard-for-windows/features/network/#sockfilter-and-other-network-drivers).
