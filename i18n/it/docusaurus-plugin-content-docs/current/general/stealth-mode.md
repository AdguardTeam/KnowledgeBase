...
Due to the nature of all web browser extensions, AdGuard Browser Extension instead works 'inside' the web browser. Altererà il Referente in quel momento, quindi, gli Strumenti per Sviluppatori mostreranno il Referente desiderato per le tue richieste.
