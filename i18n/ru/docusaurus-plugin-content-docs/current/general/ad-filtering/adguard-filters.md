...
- **Защита от отслеживания почты** блокирует пиксели отслеживания, встроенные в письма, чтобы отправители не могли видеть, когда вы открываете их, и собирать информацию о вашем устройстве или активности. [Посмотреть правила](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_25_Mail_Tracking_Protection/filter.txt)
...
- **Украинский фильтр** убирает рекламу с сайтов на украинском языке. Подробнее о фильтре можете узнать [на этой странице](https://adguard.com/en/blog/ukrainian-filter.html). [Посмотреть правила](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_23_Ukrainian/filter.txt)
