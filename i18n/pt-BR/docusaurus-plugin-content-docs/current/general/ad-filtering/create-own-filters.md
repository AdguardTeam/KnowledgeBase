...
Originally, the AdGuard's syntax was based on the syntax of Adblock Plus rules. Later, we extended it with new types of rules for better ad filtering. Algumas partes deste artigo sobre as regras comuns ao AdGuard e ao ABP foram retiradas [deste artigo](https://adblockplus.org/en/filters).
