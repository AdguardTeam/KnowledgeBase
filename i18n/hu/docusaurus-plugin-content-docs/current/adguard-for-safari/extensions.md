...
This article is about AdGuard for Safari, which safeguards only your Safari browser. A teljes eszköz védelme érdekében [töltse le az AdGuard alkalmazást](https://agrd.io/download-kb-adblock)
