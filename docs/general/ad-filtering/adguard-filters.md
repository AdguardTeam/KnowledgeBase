...
- **Ukrainian filter** removes ads from websites in Ukrainian. Originally included in the Russian filter and subsequently moved to a separate one to comply with the growing number of Ukrainian websites. Learn more about this filter on [this page](https://adguard.com/en/blog/ukrainian-filter.html). [View rules](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_23_Ukrainian/filter.txt)
