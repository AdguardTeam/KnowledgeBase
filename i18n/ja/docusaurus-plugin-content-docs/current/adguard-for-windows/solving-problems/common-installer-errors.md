...
- 以前 AdGuard をインストールしたときのファイルが残っているのかもしれません。 Uninstall AdGuard using our special [uninstall tool](/archive/adguard-for-windows/installation#advanced) and then repeat the installation.
