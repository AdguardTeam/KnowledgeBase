...
3. 要设置用于 Safari 的 AdGuard，请在 Safari 设置中启用 AdGuard 扩展。
   ...
   并非所有扩展都需要 AdGuard Safari 版才能正常运行。 For instance, checking the _Icon_ extension enables the icon next to the search bar. 不过，我们建议启用所有功能。
