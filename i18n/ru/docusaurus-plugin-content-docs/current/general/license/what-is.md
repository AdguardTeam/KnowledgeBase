...
Чтобы использовать лицензию на устройстве, войдите в приложение AdGuard через почту, связанную с лицензией. Если вы ещё не привязывали лицензию к почте, это можно сделать [в личном кабинете AdGuard](https://adguardaccount.com/). Для этого откройте вкладку *Лицензии* и нажмите *Привязать лицензию*. Usually, licenses are activated immediately, but sometimes activation may take up to five minutes.
