...
![Браузерный помощник](https://cdn.adguard.com/content/kb/ad_blocker/mac/assistantmac.jpg)
...
Если вы привыкли использовать предыдущее расширение блокировщика рекламы AdGuard [в режиме интеграции](https://kb.adguard.com/ru/browser-extensions/integration-mode), вам может понравиться решение, которое мы разработали для нового Браузерного помощника.
...
![Установка нового Браузерного помощника](https://cdn.adguard.com/content/kb/ad_blocker/mac/assistant_onboarding_safari.jpg)
...
![Вкладка Браузерного помощника](https://cdn.adguard.com/content/kb/ad_blocker/mac/assistant-separate-tab.png)
