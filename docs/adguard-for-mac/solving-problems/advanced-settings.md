...
- Firefox-based browsers behave similarly by default, but you can enable the option `network.http.http3.disable_when_third_party_roots_found` in `about:config` to allow user certificates for HTTP/3.
