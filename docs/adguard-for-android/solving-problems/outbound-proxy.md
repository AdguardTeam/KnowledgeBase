...
*The proxy mode was added in version 4.0. Here we presume that you are already WG Tunnel installed on your device, and the Wireguard configuration is already added.*
