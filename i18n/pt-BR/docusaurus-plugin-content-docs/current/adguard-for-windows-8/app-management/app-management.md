...
A maioria dos aplicativos funciona corretamente quando a filtragem está ativada. Some apps are considered “problematic” and may not work correctly when routed through AdGuard. You may see a warning like this when trying to route or filter all apps:
