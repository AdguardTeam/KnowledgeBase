...
In some cases, filtering may not work and ads may still be displayed even though AdGuard Mini for Mac and the proper filters are enabled. 이는 일반적으로 Safari 버그로 인해 필터 업데이트에 문제가 발생할 때 나타납니다.
