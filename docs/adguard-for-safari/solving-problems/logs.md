...
> AdGuard is committed to protecting your privacy. We strictly follow our [Privacy Policy](https://adguard.com/en/privacy/safari.html), and we do not collect private information about users. Before sending your logs to the support team, please be sure to review the file as it may contain additional information that you don’t want to share. If it contains such personal information, we recommend you to delete it first.
