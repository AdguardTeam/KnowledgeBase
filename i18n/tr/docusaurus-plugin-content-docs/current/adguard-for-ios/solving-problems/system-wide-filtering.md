...
Add any number of DNS filters by repeating step 4 with a different URL. [filterlists.com](https://filterlists.com) adresinde çeşitli filtre listelerini ve bağlantılarını bulabilirsiniz.
