...
3. To set up AdGuard for Safari, enable the AdGuard extensions in the Safari settings.
   ...
   Not all extensions are required for AdGuard for Safari to function correctly. For instance, checking the _Icon_ extension enables the icon next to the search bar. However, we recommend enabling all of them.
