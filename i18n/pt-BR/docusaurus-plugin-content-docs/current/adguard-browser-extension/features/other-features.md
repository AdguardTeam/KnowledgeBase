...
You can save your settings configuration by clicking the _Export settings_ button. As configurações serão salvas como um arquivo .json. To upload the previously saved settings configuration, use the _Import settings_ function. Você pode até usá-lo para alternar rapidamente entre diferentes perfis de configurações ou até mesmo para transferir configurações entre diferentes navegadores.
