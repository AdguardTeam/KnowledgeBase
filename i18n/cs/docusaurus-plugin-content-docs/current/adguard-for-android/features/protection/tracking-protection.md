...
1. **Standardní**
   ...
   b. _Požádat webové stránky, aby mě nesledovaly_. Tato funkce odesílá na navštívené webové stránky signály [Global Privacy Control](https://globalprivacycontrol.org/) a [Do Not Track](https://en.wikipedia.org/wiki/Do_Not_Track) a žádá webové aplikace, aby zakázaly sledování vaší činnosti
...
2. **Vysoká**
   ...
   d. _Požádat webové stránky, aby mě nesledovaly_. Tato funkce odesílá na navštívené webové stránky signály [Global Privacy Control](https://globalprivacycontrol.org/) a [Do Not Track](https://en.wikipedia.org/wiki/Do_Not_Track) a žádá webové aplikace, aby zakázaly sledování vaší činnosti

   e. _Smazat cookies třetích stran_. Tato funkce omezuje životnost TTL cookies třetích stran na 180 minut a zabraňuje inzerentům sledovat vaše chování na více stránkách
...
3. \*_Extrémní_ (dříve známá jako _Ultimátní_)
   ...
   f. _Blokovat WebRTC_. Tato funkce blokuje WebRTC, známou zranitelnost, která může prozradit vaši skutečnou IP adresu, i když používáte proxy server nebo VPN. Některé messengery, streamovací platformy nebo hry mohou přestat správně fungovat

   g. _Blokovat Push API_. Tato funkce blokuje vyskakovací oznámení z webových stránek
   ...
   j. _Skrýt User-Agent_. Tato funkce odstraňuje identifikační informace ze záhlaví identifikátora prohlížeče, které obvykle obsahuje název a verzi prohlížeče, operačního systému a nastavení jazyka
