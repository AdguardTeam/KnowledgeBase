...
| [Syntaxe Path-in-domain](#cosmetic-path-in-domain) |              ✅               |                ✅                |                 ✅                 |               ✅               |             ✅              |               ✅               |                 ❌                 |
...
- `shop.com/product,~shop.com/product/reviews##.upsell` — skrývá bloky dodatečného prodeje na stránkách produktů, ale ne na stránkách s recenzemi
...
- `example.org/path##.banner` namísto `[$path=/path]example.org##.banner`
