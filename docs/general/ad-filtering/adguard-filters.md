...
- **Polish filter** removes ads from websites in Polish. Originally based on the [Official Polish filters for AdBlock, uBlock Origin & AdGuard](https://github.com/MajkiIT/polish-ads-filter#polish-filters-for-adblock-ublock-origin--adguard) filter and subsequently modified by us according to the complaints from users. [View rules](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_27_Polish/filter.txt)
