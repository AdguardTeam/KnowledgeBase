...
- Pode ser que haja alguns arquivos restantes de uma instalação anterior do AdGuard. Uninstall AdGuard using our special [uninstall tool](/archive/adguard-for-windows/installation#advanced) and then repeat the installation.
