...
AdGuard can significantly broaden website functionality working as a [user script manager](/general/extensions.md). AdGuard Users can add their own scripts, as well as manage existing ones.
