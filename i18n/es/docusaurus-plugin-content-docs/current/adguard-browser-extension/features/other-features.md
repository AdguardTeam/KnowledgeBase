...
You can save your settings configuration by clicking the _Export settings_ button. La configuración se guardará como un archivo .json. To upload the previously saved settings configuration, use the _Import settings_ function. Incluso puedes usarlo para cambiar rápidamente entre diferentes perfiles de configuración o incluso para transferir configuraciones entre diferentes navegadores.
