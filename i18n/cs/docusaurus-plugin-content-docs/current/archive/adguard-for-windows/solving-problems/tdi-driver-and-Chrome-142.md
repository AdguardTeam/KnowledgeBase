...
Od verze 7.22.4 jsme přidali experimentální podporu pro ovladač SockFilter. Opravuje problém řešením konfliktů v zásobníku WFP. [More information](/archive/adguard-for-windows/features/network/#sockfilter-and-other-network-drivers).
