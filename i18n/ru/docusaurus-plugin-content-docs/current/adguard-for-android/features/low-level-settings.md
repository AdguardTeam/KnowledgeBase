...
Для AdGuard 4.x для Android мы полностью переработали Низкоуровневые настройки. Мы внесли изменения в список настроек и разбили их на тематические группы с улучшенными описаниями. Мы также добавили проверку ввода и другие защитные механизмы.
