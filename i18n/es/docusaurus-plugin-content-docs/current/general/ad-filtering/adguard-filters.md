...
Este artículo trata sobre los filtros que desarrollamos y que vienen preinstalados en AdGuard. To check them out, you can [download the AdGuard app](https://agrd.io/download-kb-adblock)
...
- **Filtro Protección de seguimiento** — lista completa de varios contadores en línea y herramientas de analítica web. Use it to hide your actions online and avoid tracking. [View rules](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_3_Spyware/filter.txt)
...
- **Protección de seguimiento de correo** bloquea los píxeles de seguimiento incrustados en los correos electrónicos para evitar que los remitentes supervisen cuándo abres los mensajes y recopilen información sobre tu dispositivo o actividad. [Ver reglas](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_25_Mail_Tracking_Protection/filter.txt)
...
- **Italian filter** removes ads from websites in Italian. Originally based on the [EasyList Italy](https://github.com/easylist/easylistitaly/) filter and subsequently modified by us according to the complaints from users. [View rules](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_26_Italian/filter.txt)
- **Polish filter** removes ads from websites in Polish. Originally based on the [Official Polish filters for AdBlock, uBlock Origin & AdGuard](https://github.com/MajkiIT/polish-ads-filter#polish-filters-for-adblock-ublock-origin--adguard) and subsequently modified by us according to the complaints from users. [View rules](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_27_Polish/filter.txt)
