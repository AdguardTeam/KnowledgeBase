...
![Главный экран *mobile](https://cdn.adtidy.org/content/kb/ad_blocker/mac/Mainscreen.png)
...
![Всплывающее меню Помощника *mobile](https://cdn.adtidy.org/content/kb/ad_blocker/mac/safari_assistant_pop-up_menu.jpg)
...
This version of Assistant is legacy and there is no point in using it on new systems, since it has been replaced with the full-fledged Browser Assistant. Но старый Помощник может пригодиться, если для вашего браузера нет расширения Браузерного помощника.
