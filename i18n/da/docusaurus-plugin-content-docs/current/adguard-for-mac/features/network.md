...
By default, AdGuard doesn’t filter websites with Extended Validation (EV) certificates. Indstillingen _Filtrér websteder med EV-certifikater_ kan om ønsket slås til.
