...
![Regole globali del firewall \*mobile\_border](https://cdn.adtidy.org/blog/new/4zx2nhglobal_rules.png)
...
1. Apri _Regole firewall personalizzate_. Sotto _App con regole personalizzate_, tocca _Aggiungi app_.
   ...
   ![Regole firewall personalizzate \*mobile\_border](https://cdn.adtidy.org/blog/new/qkxpecustom_rules.png)

2. Seleziona l'app per cui desideri impostare delle regole individuali.

   ![Aggiunta di un'app alle regole firewall personalizzate \*mobile\_border](https://cdn.adtidy.org/blog/new/2db47fadding_app.png)
...
3. In _Regole personalizzate disponibili_, seleziona quelle che desideri configurare e tocca l'icona "+". Le regole ora appariranno in _Regole personalizzate applicate_.
   ...
   ![Regola aggiunta \*mobile\_border](https://cdn.adtidy.org/blog/new/6fzjladded_rule.png)
