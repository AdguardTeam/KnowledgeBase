...
Основная цель любого блокировщика — блокировать рекламу, и у большинства программ AdGuard одинаковые алгоритмы фильтрации. Механизм фильтрации рекламы описан [здесь](/general/ad-filtering/how-ad-blocking-works.md).
...
Сейчас большинство сайтов работают через HTTPS — защищённый веб-протокол. It happened so that most advertisers use this protocol as well, this is why [HTTPS filtering](/general/https-filtering/what-is-https-filtering.md) is really crucial for a modern ad blocker.
