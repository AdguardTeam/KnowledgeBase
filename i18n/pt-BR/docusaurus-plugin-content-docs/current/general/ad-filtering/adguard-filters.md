...
- **Proteção contra rastreamento de e-mail** bloqueia pixels de rastreamento incorporados em e-mails para impedir que remetentes monitorem quando você abre mensagens e coletem informações sobre seu dispositivo ou atividade. [Ver regras](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_25_Mail_Tracking_Protection/filter.txt)
