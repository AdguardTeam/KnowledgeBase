...
1. Folgen Sie auf demselben Computer mit AdGuard diesem Link: [http://local.adguard.org/cert](https://local.adguard.org/cert).
...
1. Folgen Sie diesem Link in einem Webbrowser:[http://local.adguard.org/cert](https://local.adguard.org/cert).
...
1. Folgen Sie auf dem Computer mit AdGuard diesem Link in einem Browser: [http://local.adguard.org/cert](https://local.adguard.org/cert).
