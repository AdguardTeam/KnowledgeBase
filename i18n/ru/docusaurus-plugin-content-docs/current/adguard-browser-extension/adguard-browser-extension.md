...
- [Браузерное расширение AdGuard MV2: где использовать и как установить](/adguard-browser-extension/mv2-version/)

  Браузеры, где MV2 ещё можно использовать, и практические варианты установки
