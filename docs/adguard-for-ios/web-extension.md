...
![What the Web extension looks like in Safari](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/menu_en.png)
...
![Web extension menu](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/ext_adguard_en.png?1)
...
![Select "Safari"](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/settings1_en.png)

![Select "Extensions"](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/settings2_en.png)

Find **ALLOW THESE EXTENSIONS** section and then find **AdGuard** among the available extensions. 

![Select "AdGuard" in ALLOW THESE EXTENSIONS section](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/settings3_en.png)
...
![In Safari tap aA icon](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/safari1_en.png)

Then find the *Manage Extensions* option in the list and tap it. In the opened window turn on the switch next to **AdGuard**. 

![](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/safari2_en.png)

![](https://cdn.adtidy.org/public/Adguard/kb/iOS/webext/safari3_en.png)
