...
4. Send the log file to [devteam@adguard.com](mailto:devteam@adguard.com). 请指定错误的时间，并附上您的 GitHub 问题或其编号的链接 (它显示为标题旁边的 #number) 。 Alternatively, you can upload the log file to Google Drive and share it with [devteam@adguard.com](mailto:devteam@adguard.com). 将文件链接附加到您创建的 GitHub 问题。
