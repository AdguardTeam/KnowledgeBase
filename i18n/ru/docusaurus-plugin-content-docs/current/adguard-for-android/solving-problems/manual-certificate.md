...
1. После сохранения скопируйте текст из поля *Сертификат центра сертификации (Сертификат ЦС или Сертификат CA)* и нажмите *Открыть настройки*.

1. Откройте *Настройки* и либо вставьте, либо введите *Сертификат центра сертификации (Сертификат ЦС или Сертификат CA)* в строку поиска. Выберите нужный вариант.

1. Выберите файл сертификата AdGuard. В таком случае нажмите *Всё равно установить* и при необходимости введите свой PIN-код.
