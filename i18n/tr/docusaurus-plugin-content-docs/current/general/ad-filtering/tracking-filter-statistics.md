...
It's important to note that all the statistics we get are averaged and anonymized. We don't use these statistics for any purpose other than optimizing the filters, and we do not sell this data to third parties. Gizlilik Politikamızı [buradan](https://adguard.com/privacy.html) okuyabilirsiniz.
