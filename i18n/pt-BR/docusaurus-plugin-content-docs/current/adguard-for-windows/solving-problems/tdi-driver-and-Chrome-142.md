...
A partir da v8.0 RC, adicionamos suporte experimental para o driver SockFilter. Ele corrige o problema ao resolver conflitos no stack WFP. [More information](/adguard-for-windows/settings/app-settings/network-settings/).
