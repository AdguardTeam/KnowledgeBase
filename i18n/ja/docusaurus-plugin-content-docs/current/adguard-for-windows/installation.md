...
1. You’ll see a User Account Control prompt asking if you want to allow the app to make changes to your PC. 「*はい*」をクリックしてください。
...
1. インストールが完了しましたら、「*終了*」を押します。

    ![インストール完了 *border](https://cdn.adtidy.org/content/kb/ad_blocker/windows/installation/installation_new/installation_completed.png)
...
1. Use `/adblocker` to uninstall AdGuard for Windows. It should look like this:
