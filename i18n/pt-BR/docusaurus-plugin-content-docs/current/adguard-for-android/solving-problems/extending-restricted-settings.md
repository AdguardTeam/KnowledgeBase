...
## Para usuários da One Ui 7.0

Em dispositivos Samsung com OneUI 7.0, as configurações de permissões do aplicativo seguem um caminho diferente. Siga estes passos para configurar o acesso de uso do aplicativo:

1. Abra _Configurações do sistema_ → _Aplicativos_

![Configurações de apps \*dispositivo móvel](https://cdn.adtidy.org/content/kb/ad_blocker/android/solving_problems/problems-caused-by-extending-restricted-settings/apps.jpg)

1. Toque no ícone de menu (⋮) no canto superior direito e selecione _Acesso especial_

![Acesso especial \*mobile](https://cdn.adtidy.org/content/kb/ad_blocker/android/solving_problems/problems-caused-by-extending-restricted-settings/three-dots.jpg)

1. Selecione _Acesso aos dados de uso_

![Menu de acesso especial \*mobile](https://cdn.adtidy.org/content/kb/ad_blocker/android/solving-problems/problems-caused-by-extending-restricted-settings/special.jpg)

1. Encontre e ative o _AdGuard_

![Acesso aos dados de uso \*mobile](https://cdn.adtidy.org/content/kb/ad_blocker/android/solving_problems/problems-caused-by-extending-restricted-settings/usage_data.jpg)
