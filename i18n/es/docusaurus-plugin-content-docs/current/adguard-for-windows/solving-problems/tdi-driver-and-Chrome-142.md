...
Desde la versión 8.0 RC, hemos añadido soporte experimental para el controlador SockFilter. Soluciona el problema al resolver conflictos en la stack WFP. [Más información](/adguard-for-windows/settings/app-settings/network-settings/).
