...
启用此选项可在加载系统后打开 AdGuard 主窗口。 This setting, which doesn't affect whether the actual filtering service is launched or not, is located in *Settings → General Settings*.
