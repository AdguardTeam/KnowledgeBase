...
1. You’ll see a User Account Control prompt asking if you want to allow the app to make changes to your PC. Faceți clic pe *Da*.
...
1. Așteptați finalizarea instalării și faceți clic pe *Finalizare*.

    ![Finalizarea instalării *border](https://cdn.adtidy.org/content/kb/ad_blocker/windows/installation/installation_new/installation_completed.png)
...
1. Use `/adblocker` to uninstall AdGuard for Windows. Ar trebui să arate astfel:
