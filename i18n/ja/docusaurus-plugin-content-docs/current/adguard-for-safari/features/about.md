...
AdGuard for Safari は無料で [App Store からダウンロード](https://apps.apple.com/app/adguard-for-safari/id1440147259)できます。 詳しいセットアップ手順は、[こちらのナレッジベース記事](/archive/adguard-for-safari/installation/)にあります。
