...
- [Recursos](/archive/adguard-for-windows/features/features.md)

  Main features and settings available in AdGuard for Windows

- [Instalação](/archive/adguard-for-windows/installation.md)

  Instalação, desinstalação e requisitos de sistema do AdGuard para Windows

- [Assistente de navegador](/archive/adguard-for-windows/browser-assistant.md)

  Uma extensão que complementa o aplicativo de computador e permite que você gerencie a filtragem do seu navegador

- [Resolvendo problemas](/archive/adguard-for-windows/solving-problems/solving-problems.md)

  Problemas conhecidos e possíveis soluções

- [Documentação para administradores](/archive/adguard-for-windows/admins-documentation.md)
