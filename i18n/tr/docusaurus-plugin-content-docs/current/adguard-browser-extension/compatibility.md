...
Bilgisayarınıza hem uzantıyı hem de bağımsız programı yüklemeye karar verirseniz bazı uyumluluk sorunlarıyla karşılaşabilirsiniz. Sorun, bazı durumlarda uygulama ve uzantının birbirine müdahale edebilmesidir. Bazı siteler artık masaüstü programı tarafından korunmayacak ve yalnızca daha az seçeneğe sahip uzantı tarafından korunacaktır. Ayrıca, filtreleme bazı siteler için hatalı çalışabilir. Therefore, we don’t recommend using the extension together with the application.
