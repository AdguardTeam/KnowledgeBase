...
[AdGuard ブラウザ拡張機能](https://adguard.com/adguard-browser-extension/overview.html) は、Chrome、Firefox、Edge、Opera、Yandex Browser という 5 つの人気ブラウザで使える無料の拡張機能です。 You can find and install it via your browser’s web store or download it from our official website.
