...
- **메일 추적 보호**는 이메일에 삽입된 추적 픽셀을 차단하여 발신자가 메시지 열람 여부를 모니터링하거나 사용자의 기기 및 활동 정보를 수집하는 것을 방지합니다. [규칙 보기](https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/master/filters/filter_25_Mail_Tracking_Protection/filter.txt)
