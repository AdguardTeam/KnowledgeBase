...
Если вы хотите узнать больше о безопасности браузера, читайте [эту статью](/general/browsing-security).
