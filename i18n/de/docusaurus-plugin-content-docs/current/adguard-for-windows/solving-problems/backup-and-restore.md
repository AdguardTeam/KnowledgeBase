...
6. Starten Sie AdGuard. Your previous settings, filters, and custom rules will be restored.
...
7. Starten Sie AdGuard. Version 7 will start with your previous settings restored.
