...
4. Send the log file to [devteam@adguard.com](mailto:devteam@adguard.com). メールにバグの発生時刻とissueへのリンクまたはissue番号（番号はissueタイトルの横に「#○○」として表示されます）を記載してください。 Alternatively, you can upload the log file to Google Drive and share it with [devteam@adguard.com](mailto:devteam@adguard.com). GitHubのissueにもファイルへのリンクを追加してください。
