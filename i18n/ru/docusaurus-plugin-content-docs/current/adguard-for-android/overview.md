...
Если у вас возникли проблемы с установкой сертификата, прочитайте [эту статью](/adguard-for-android/solving-problems/manual-certificate) или обратитесь в [поддержку](/support/contact).
