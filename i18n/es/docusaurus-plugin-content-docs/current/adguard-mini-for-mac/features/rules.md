...
User rules can be used to customize ad blocking when you want something personal: exclude a website from filtering, unblock requests, or allow scripts on a certain webpage. Pueden añadirse manualmente, importarse o crearse automáticamente al bloquear un elemento en la página.

Para agregar tus propias reglas de filtrado, utiliza una [sintaxis especial](/general/ad-filtering/create-own-filters).
