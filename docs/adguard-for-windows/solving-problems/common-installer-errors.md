...
- Please email all these files from two previous steps to support@adguard.com and describe the problem in the message body. Our tech support agents will reply to you as soon as possible.
