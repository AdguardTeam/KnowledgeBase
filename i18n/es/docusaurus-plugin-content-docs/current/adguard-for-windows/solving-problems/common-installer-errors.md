...
- Tal vez haya algunos archivos sobrantes de una instalación anterior de AdGuard. Uninstall AdGuard using our special [uninstall tool](/archive/adguard-for-windows/installation#advanced) and then repeat the installation.
