...
6. Inicie o AdGuard. Your previous settings, filters, and custom rules will be restored.
...
7. Inicie o AdGuard. Version 7 will start with your previous settings restored.
