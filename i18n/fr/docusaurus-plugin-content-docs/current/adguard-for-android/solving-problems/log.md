...
1. Après avoir créé un problème sur GitHub, envoyez le fichier journal à [devteam@adguard.com](mailto:devteam@adguard.com). Indiquez la date du bug et joignez un lien vers votre problème ou son numéro (il apparaît sous la forme #numéro à côté du titre). Vous pouvez également télécharger le fichier journal sur Google Drive et l'envoyer à [devteam@adguard.com](mailto:devteam@adguard.com). Ajoutez le lien du fichier à votre problème GitHub
