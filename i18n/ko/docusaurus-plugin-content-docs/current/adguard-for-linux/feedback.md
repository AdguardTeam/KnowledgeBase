...
4. 로그 파일을 [devteam@adguard.com](mailto:devteam@adguard.com)로 보내세요. 오류가 발생한 시간을 지정하고 GitHub 이슈 링크 또는 번호(제목 옆에 #번호로 표시됨)를 첨부합니다. 또는 로그 파일을 Google Drive에 업로드하여 [devteam@adguard.com](mailto:devteam@adguard.com)와 공유할 수 있습니다. GitHub 문제에 파일 링크를 첨부하세요.
