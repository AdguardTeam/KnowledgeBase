...
Here is the [official documentation](/general/ad-filtering/create-own-filters.md) on the syntax of AdGuard filtering rules. Please read it carefully: it will help you create your own filtering rules.
