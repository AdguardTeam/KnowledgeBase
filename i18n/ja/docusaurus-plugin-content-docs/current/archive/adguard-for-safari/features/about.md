...
AdGuard for Safari は無料で [App Store からダウンロード](https://apps.apple.com/app/adguard-for-safari/id1440147259)できます。 A detailed setup instruction is available in the [Knowledge Base](/archive/adguard-for-safari/installation/).
