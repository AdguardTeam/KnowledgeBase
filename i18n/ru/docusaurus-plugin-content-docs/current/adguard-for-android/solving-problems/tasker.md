...
`pause` приостанавливает защиту. The difference between this and `stop` is that a notification will appear that restarts the protection when you tap it. Дополнительные параметры не нужны;
