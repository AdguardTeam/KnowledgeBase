...
These filters may contain rules that are not suitable for all users. Sometimes it is recommended to disable them. Las decisiones de agregar reglas a este filtro son tomadas por los desarrolladores de filtros, una por una.
