...
> Read more about [AdGuard filters](./general/ad-filtering/adguard-filters) or [ad filtering in general](_category_.json/general/ad-filtering/how-ad-blocking-works).
