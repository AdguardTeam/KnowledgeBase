...
#### Modalità IU semplificata

Se questa impostazione è attivata, AdGuard mostrerà solo l’icona DNS nella schermata iniziale dell’app.
...
#### Mostra le app clonate

Se questa impostazione è abilitata, potrai modificare le impostazioni di instradamento, filtraggio e firewall per le app clonate in _Gestione delle app_.
