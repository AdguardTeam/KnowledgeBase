...
In some cases, filtering may not work and ads may still be displayed even though AdGuard Mini for Mac and the proper filters are enabled. Bu genellikle Safari hataları nedeniyle filtre güncellemelerinde bir şeyler ters gittiğinde olur.
