...
![On the App Store main screen, tap Search](https://cdn.adtidy.org/public/Adguard/kb/installation/iOS/en/1.png)

Type _adguard_ in the search bar and tap the string _adGuard_ which will be among search results.

![Type "AdGuard" in the search bar](https://cdn.adtidy.org/public/Adguard/kb/installation/iOS/en/2.png)
...
![Tap GET below the AdGuard app](https://cdn.adtidy.org/public/Adguard/kb/installation/iOS/en/3.png)
