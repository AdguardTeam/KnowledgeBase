...
In some cases, filtering may not work and ads may still be displayed even though AdGuard Mini for Mac and the proper filters are enabled. Isso geralmente acontece quando algo dá errado com as atualizações de filtros devido a bugs do Safari.
