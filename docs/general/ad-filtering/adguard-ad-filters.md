...
Here is the [official documentation](ссылка на how-to-create-your-own-ad-filters) on the syntax of AdGuard filtering rules. Please read it carefully: it will help you create your own filtering rules.
