...
3. Vedrai la finestra di dialogo Controllo dell'account utente che richiede di consentire all'app di apportare modifiche al tuo PC. Click _Yes_.
...
5. Wait for the installation to complete and click _Finish_.
   ...
   Felicitazioni! AdGuard has been successfully installed. Sullo schermo vedrai la finestra principale, in cui puoi modificare le impostazioni dell'app.
