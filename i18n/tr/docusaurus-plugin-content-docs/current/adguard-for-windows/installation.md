...
1. You’ll see a User Account Control prompt asking if you want to allow the app to make changes to your PC. *Evet* öğesine tıklayın.
...
1. Kurulumun tamamlanmasını bekleyin ve *Bitir* öğesine tıklayın.

    ![Kurulumu bitir *border](https://cdn.adtidy.org/content/kb/ad_blocker/windows/installation/installation_new/installation_completed.png)
...
1. Use `/adblocker` to uninstall AdGuard for Windows. Bu şöyle görünmelidir:
