...
Aktivér denne funktion for at se AdGuard pop op-notifikationer. De vises ikke for ofte og indeholder kun vigtig information. You can also use the tray menu to recall the last pop-up notification.
