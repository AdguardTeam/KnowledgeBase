...
This approach is available starting from **AdGuard v3.5 nightly 6**. Si vous utilisez une version plus ancienne, vous pouvez obtenir la dernière mise à jour [ici](https://adguard.com/adguard-android/overview.html).
