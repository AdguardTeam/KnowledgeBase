...
In some cases, filtering may not work and ads may still be displayed even though AdGuard Mini for Mac and the proper filters are enabled. Обычно это происходит, когда что-то не так с обновлениями фильтров из-за ошибок Safari.
