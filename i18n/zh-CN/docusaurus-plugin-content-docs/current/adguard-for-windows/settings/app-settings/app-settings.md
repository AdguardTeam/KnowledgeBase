...
[_Advanced_](/adguard-for-windows/settings/app-settings/advanced-settings.md) settings are intended for experienced users. 这些设置在日常使用中很少用到，只有在您明确自己的操作或技术支持团队要求时，才应进行更改。
