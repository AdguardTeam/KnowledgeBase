...
3. **Extremo** (anteriormente conhecido como _Ultimate_)
   ...
   f. _Bloquear WebRTC_. Este recurso bloqueia WebRTC, uma vulnerabilidade conhecida que pode vazar seu endereço IP real mesmo se você usar um proxy ou VPN Alguns aplicativos de mensagens, plataformas de streaming ou jogos podem parar de funcionar corretamente
