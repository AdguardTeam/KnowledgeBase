...
Die Funktion Tracking-Schutz mit der Schutzstufe <em x-id=„3“>Hoch</em> aktiviert den AdGuard URL-Tracking-Filter, der Anfragen verändert, indem er Tracking-Parameter aus ihnen entfernt:
