...
4. Send the log file to [devteam@adguard.com](mailto:devteam@adguard.com). 오류가 발생한 시간을 지정하고 GitHub 이슈 링크 또는 번호(제목 옆에 #번호로 표시됨)를 첨부합니다. Alternatively, you can upload the log file to Google Drive and share it with [devteam@adguard.com](mailto:devteam@adguard.com). GitHub 문제에 파일 링크를 첨부하세요.
