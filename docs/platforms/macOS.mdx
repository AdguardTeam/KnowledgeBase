...
<Image img={require('./assets/1-General.png')} />
...
<Image img={require('./assets/4-Filters.png')} />
...
<Image img={require('./assets/3-StealthMode-1.png')} />
...
<Image img={require('./assets/6-BrowsingSecurity.png')} />
...
<Image img={require('./assets/5-BrowserAssistant.png')} />
...
<Image img={require('./assets/safari_assistant_pop-up_menu.png')} />
...
<Image img={require('./assets/7-Extensions.png')} />
...
<Image img={require('./assets/9-NetworkFiltering.png')} />
...
<Image img={require('./assets/11-LicenceManagement.png')} />
...
<Image img={require('./assets/12-support.png')} />
