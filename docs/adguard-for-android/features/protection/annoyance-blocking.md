...
The Annoyance blocking feature can be accessed by tapping the *Protection* tab (second-left icon at the bottom of the screen) and then selecting *Annoyance blocking*.
