...
AdGuard 浏览器助手是一款浏览器扩展，其工作方式和样式与 AdGuard 浏览器扩展一样，但它更轻量，并且不会干扰桌面应用程序。 You can [read more about Browser Assistant for Windows](/archive/adguard-for-windows/browser-assistant) or [Mac](/adguard-for-mac/features/browser-assistant), or [download it from our website](https://adguard.com/adguard-assistant/overview.html).
