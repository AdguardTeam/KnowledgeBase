...
Zuerst melden Sie sich bei Ihrer AdGuard-App mit jener E-Mail-Adresse an, die mit der Lizenz verknüpft ist. If the license hasn't been bound to your email address yet, you can do it in your [AdGuard account](https://adguardaccount.com). Öffnen Sie dazu den Tab *Lizenzen* und klicken Sie auf *Lizenz verknüpfen*. Im Allgemeinen werden Lizenzen sofort aktiviert, aber manchmal kann die Aktivierung bis zu fünf Minuten dauern.
