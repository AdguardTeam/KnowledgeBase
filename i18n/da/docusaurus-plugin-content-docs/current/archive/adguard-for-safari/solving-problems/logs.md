...
2. Send the log file to devteam@adguard.com. Medtag tidspunktet for fejlen, og vedhæft et link til problematikken eller dens nummer (angivet som #number ved siden af titlen).
