...
You must enable the *Allow user scripts* toggle. To do so, open the Chrome menu by clicking the three dots in the upper-right corner, go to *Extensions* ⭢ *Manage extensions*, go to the extension’s *Details*, and toggle the *Allow user scripts* switch.
