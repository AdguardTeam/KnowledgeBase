...
O Assistente de navegador AdGuard é uma extensão de navegador. It allows you to quickly manage AdGuard for Linux:
...
3. Instale o Assistante a partir da loja de extensões do seu navegador.
