...
Мы с радостью примем любую помощь! If you want to send us a complaint about a phishing or malware site, you can do it via [technical support](mailto:support@adguard.com) or [on our forum](http://forum.adguard.com/).
