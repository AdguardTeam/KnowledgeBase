...
3. **Extremo** (anteriormente conocido como _Ultimate_)
   ...
   f. _Bloquear WebRTC_. Esta función bloquea WebRTC, una vulnerabilidad conocida que puede filtrar tu dirección IP real incluso si utilizas un proxy o VPN Algunos mensajeros, plataformas de transmisión o juegos pueden parar de funcionar correctamente
