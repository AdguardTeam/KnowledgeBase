...
1. Depois de criar um problema no GitHub, envie o arquivo de registro para [devteam@adguard.com](mailto:devteam@adguard.com). Inclua a hora do bug e anexe um link para o seu problema ou seu número (aparece como #number próximo ao título). Alternativamente, você pode fazer upload do arquivo de registro para o Google Drive e enviá-lo para [devteam@adguard.com](mailto:devteam@adguard.com). Adicione o link do arquivo ao seu problema do GitHub
