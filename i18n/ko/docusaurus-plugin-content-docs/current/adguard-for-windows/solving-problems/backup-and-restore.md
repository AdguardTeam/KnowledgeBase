...
6. AdGuard를 실행합니다. Your previous settings, filters, and custom rules will be restored.
...
7. AdGuard를 실행합니다. Version 7 will start with your previous settings restored.
