...
You'll find DNS user filter at *Settings → DNS Filtering → DNS Requests blocking*. Пользовательский фильтр DNS поддерживает два типа синтаксиса: синтаксис AdGuard в урезанной форме и hosts-синтаксис. Познакомиться с ними ближе вы можете в нашей Базе знаний.
