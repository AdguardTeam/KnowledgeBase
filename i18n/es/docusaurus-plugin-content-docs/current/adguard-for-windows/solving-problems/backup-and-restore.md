...
6. Inicia AdGuard. Your previous settings, filters, and custom rules will be restored.
...
7. Inicia AdGuard. Version 7 will start with your previous settings restored.
