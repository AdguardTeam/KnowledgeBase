...
From v7.22.4, we’ve added experimental support for the SockFilter driver. 它通过解决 WFP 协议栈中的冲突来修复该问题。 [更多信息](/archive/adguard-for-windows/features/network/#sockfilter-and-other-network-drivers)。
